...
<body>
            ...
            <div class="card bg-glass">
              <div class="card-body px-4 py-5 px-md-5">
                <form id="myForm" class="login" action="Auth.php" onsubmit="return isvalid()" method="POST">
                  <button class="UserLogin" onclick="window.location.href='index.php';">
                  User_Login->
                  </button>
                  <div class="row mt-4">
  ...
  <button class="social"><img src="./Images/twitter.png" alt="" height="32"></button>
    ...
    <!-- MDB -->
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/mdb-ui-kit/6.2.0/mdb.min.js" integrity="sha512-kY9kdF1Prk/4kL5VPgANqJ6LQ7FT0TSLpj7kTsyDCzS5XS1jqmUtJp7FrcULt9IXiLxJo4J6TPvjKL75mW8W2g==" crossorigin="anonymous"></script>
    <script>
      function isvalid() {
